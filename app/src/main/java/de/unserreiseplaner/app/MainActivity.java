...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " UnserReiseplaner/1.2.0");
    ...
    private void beginUpdateDownload(String url, String versionLabel) {
        ...
        executor.submit(() -> {
            ...
            try {
                ...
                connection.setRequestProperty("User-Agent", "UnserReiseplaner/1.2.0 Android updater");
        ...
        public void request(String id, String url) {
            executor.submit(() -> {
                ...
                try {
                    ...
                    String agent = "UnserReiseplanerBot/1.2.0 (https://github.com/wasserratte96-web/unser-reiseplaner)";
